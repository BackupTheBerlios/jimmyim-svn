...
\begin{itemize}
  \item \textbf{MSNTransaction:} skrbi za pravilno obliko otevilèenje sporoèil
...
\item zaèetna predstavljanje:
  ...
  \item CVR: podatki o klientu(verzija, naziv), operacijskem sistemu in raèunalniki arhitekturi uporabnika
  \end{itemize}
