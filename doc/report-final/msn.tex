...
kdajkoli prej in za¾eljeno je, da so proizvodi odprte narave (bodisi odprtokodni ali pa potrjeni
...
Osnova za implementacijo je razred MSNProtocol, ki podeduje abstraktni razred Protocol.java. Za pravilno delovanje so potrebni ¹e ostali razredi:
\begin{itemize}
...
\subsection{Od prijave do sporoèanja}
	...
	Seja MSN protokola poteka vsebuje najprej povezavo s t.i. ``Notification serverjem'', ki posreduje podatke o prisotnosti. Notification server dovoljuje uporabniku, da se pove¾e na Switchboard stre¾nik, ki  opravlja zahteve neposrednega sporoèanja.
...
\item zaèetna predstavljanje:
  ...
  \item CVR: podatki o odjemalcucd(verzija, naziv), operacijskem sistemu in raèunalniki arhitekturi uporabnika
  \end{itemize}
