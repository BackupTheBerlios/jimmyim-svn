...
public class ServerHandler
{
    ...
    private Socket sc_;	//main connection
    ...
    public void connect(boolean useSSL)
    {
        ...
        try
        {
          if (useSSL)
          {
            this.sc_ = HttpsURLConnection.getDefaultSSLSocketFactory().createSocket(
                url_,
                outPort_);
          }
          else
          {
            this.sc_ = SocketFactory.getDefault().createSocket(
                url_,
                outPort_);
          }
          
//          sc_.connect(new SocketAddress(){});
...
//        	this.sc_ = (SocketConnection)Connector.open("socket://" + this.url_ + ":" + String.valueOf(this.outPort_));
            ...
            this.os_ = new DataOutputStream(this.sc_.getOutputStream());
            this.is_ = new DataInputStream(this.sc_.getInputStream());
